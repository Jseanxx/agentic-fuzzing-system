# JPEG2000 / OpenHTJ2K Target Testbed

> This directory preserves the JPEG2000/OpenHTJ2K target as a **testbed inside the larger Agentic Fuzzing System repo**.
>
> Read this target together with:
> - `../../skills/harness-engineering-loop/SKILL.md`
> - `fuzz-records/README.md`
> - `fuzz-records/current-status.md`
> - `fuzz-records/progress-index.md`
>
> The upstream OpenHTJ2K code and the fuzzing/control-plane extensions live together here because this target is the main validation bed for the broader agentic fuzzing workflow.
